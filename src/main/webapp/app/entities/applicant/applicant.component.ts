...
export class ApplicantComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.applicantService
      ...
      .subscribe(
        (res: HttpResponse<IApplicant[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInApplicants(): void {
    this.eventSubscriber = this.eventManager.subscribe('applicantListModification', () => this.loadPage());
  }
