package aust.edu.config.timezone;

import aust.edu.PgadmissionApp;
import aust.edu.repository.timezone.DateTimeWrapper;
import aust.edu.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pg_date_time_wrapper where id=%d", fieldName, id);
    }
