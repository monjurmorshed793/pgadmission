...
import { ApplicationDeadlineComponent } from 'app/entities/application-deadline/application-deadline.component';
...
describe('Component Tests', () => {
  describe('ApplicationDeadline Management Component', () => {
    let comp: ApplicationDeadlineComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplicationDeadlineComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ApplicationDeadline(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.applicationDeadlines && comp.applicationDeadlines[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
